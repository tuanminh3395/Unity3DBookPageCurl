...
namespace FrogunnerGames.Coroutine
{
...
public static class MECExtensionMethods
{
    ...
    {
        while (FrogunnerGames.Coroutine.Timing.MainThread != System.Threading.Thread.CurrentThread || (gameObject && gameObject.activeInHierarchy && coroutine.MoveNext()))
    ...
    {
        while (FrogunnerGames.Coroutine.Timing.MainThread != System.Threading.Thread.CurrentThread || (gameObject1 && gameObject1.activeInHierarchy &&
